/*
 * <h1>Place interface</h1>.
 * This interface implements the popular places window for the selected city .
 * <p>
 */
...
public class Place extends javax.swing.JFrame {
    ...
    static ArrayList<Places> pp = new ArrayList<Places>();
    int counter = 0;
    /**
     *
     * @param p Array list of places to show the places of selected city
     */
    public Place(ArrayList<Places> p) {
...
//
//                pp.add(count, p.get(i));
//
//            }
//
//        }
        jTextArea3.setText(pp.get(0).toString());

        jTextArea4.setText(pp.get(1).toString());
    ...
    private void fillArr(ArrayList<Places> p){
                for (int i = 0; i < p.size(); i++) {

            if (city.equals(p.get(i).getCityGuide())) {

                pp.add(counter, p.get(i));
                counter++;
